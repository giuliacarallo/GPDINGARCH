...
load('CyberAttacks2017_2018.mat')

%% MH-WITHIN-GIBBS SAMPLING
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T=length(Z); %only for 3 years
%Z = Z_old;
%T=length(Z_old);
n=1;
p=1;
q=1;
lambda=0.4;
%lambda = 0; %for the PD-INGARCH/inarch simulation
alpha = 0.40;
%beta = 0; % for the INARCH example
beta = 0.25;
...
% 
% if i > nburn
%    xpostNew = xpost(nburn+1:end,:);
%    ypostNew = ypost(nburn+1:end,:);
%    alpha0GibbsNew2 = alpha0Gibbs(nburn+1:end,1);
%    alphaGibbsNew2 = alphaGibbs(nburn+1:end,:);
%    betaGibbsNew2 = betaGibbs(nburn+1:end,:);
%    phiGibbsNew2 = phiGibbs(nburn+1:end,1);
%    lambdaGibbsNew2 = lambdaGibbs(nburn+1:end,1);
%    %    ac = ac(nburn+1:end,:);
%    %    acvarphi = acvarphi(nburn+1:end);
%    %    acalpha0 = acalpha0(nburn+1:end);
%    %    acphilambda = acphilambda(nburn+1:end);
% end
...
%save('/Users/giuliacarallo/Desktop/GIBBS/Code_Cyber/CyberAttacksAdaptive171819.mat')
%save('/Users/giuliacarallo/Desktop/GIBBS/Code_Cyber/CyberAttacksAdaptive171819GPIN.mat')
%save('/Users/giuliacarallo/Desktop/GIBBS/Code_Cyber/CyberAttacksAdaptive171819PDIN.mat')
%save('/Users/giuliacarallo/Desktop/GIBBS/Code_Cyber/CyberAttacksAdaptive171819PD.mat')

%save('/Users/giuliacarallo/Desktop/GIBBS/Code_Cyber/CyberAttacksAdaptive3.mat')
%save('/Users/giuliacarallo/Desktop/GIBBS/Code_Cyber/CyberAttacksAdaptiveGPIN.mat')
%save('/Users/giuliacarallo/Desktop/GIBBS/Code_Cyber/CyberAttacksAdaptivePDIN.mat')
%save('/Users/giuliacarallo/Desktop/GIBBS/Code_Cyber/CyberAttacksAdaptivePD.mat')


%save('CyberAttacksEstppTemp.mat')
%save('CyberAttacksEstPD.mat') %when estimated PD-INGARCH
%save('CyberAttacksEstPDIN.mat') %when estimated PD-INARCH
%save('CyberAttacksEstGPDIN.mat') %when estimated GPD-INARCH
